...
#     assert does_string_contain_pattern("Hello, world", ["world", ""]) == False

#     # Test when the string does not contain any pattern
#     assert (
#         does_string_contain_pattern("Hello, world", ["Goodbye", "earth"]) == True
#     )

#     # Test when the string is empty
#     assert does_string_contain_pattern("", ["Hell", "world"]) == True

#     # Test when the pattern list is empty
#     assert does_string_contain_pattern("Hello, world", []) == True

#     # Test when the string and the pattern list are both empty
#     assert does_string_contain_pattern("", []) == True
...
#     # Test when the string contains a pattern
#     assert (
#         does_string_contain_pattern("Hello, world", ["world", ""]) is False
#     ), "Failed when the string contains a pattern"

#     # Test when the string does not contain any pattern
#     assert (
#         does_string_contain_pattern("Hello, world", ["Goodbye", "earth"]) is True
#     ), "Failed when the string does not contain any pattern"

#     # Test when the string is empty
#     assert (
#         does_string_contain_pattern("", ["Hell", "world"]) is True
#     ), "Failed when the string is empty"

#     # Test when the pattern list is empty
#     assert (
#         does_string_contain_pattern("Hello, world", []) is True
#     ), "Failed when the pattern list is empty"

#     # Test when the string and the pattern list are both empty
#     assert (
#         does_string_contain_pattern("", []) is True
...
# def test_does_string_starts_with_pattern():
#     # Test when the string starts with a pattern
#     assert (
#         does_string_starts_with_pattern("Hello, world", ["Hell", "world"]) is False
#     ), "Failed when the string starts with a pattern"

#     # Test when the string does not start with any pattern
#     assert (
#         does_string_starts_with_pattern("Hello, world", ["Goodbye", "earth"]) is True
#     ), "Failed when the string does not start with any pattern"

#     # Test when the string is empty
#     assert (
#         does_string_starts_with_pattern("", ["Hell", "world"]) is True
#     ), "Failed when the string is empty"

#     # Test when the pattern list is empty
#     assert (
#         does_string_starts_with_pattern("Hello, world", []) is True
#     ), "Failed when the pattern list is empty"

#     # Test when the string and the pattern list are both empty
#     assert (
#         does_string_starts_with_pattern("", []) is True
#     ), "Failed when the string and the pattern list are both empty"
...
#     assert (
#         does_string_starts_with_pattern("hello, world", ["Hell", "world"]) is True
